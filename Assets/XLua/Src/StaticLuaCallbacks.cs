    ...
    public partial class StaticLuaCallbacks
    {
        ...
        public static int EnumAnd(RealStatePtr L)
        {
            try
            {
                ...
                {
                    return LuaAPI.luaL_error(L, "invalid argument for EnumUtility BitwiseAnd");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "c# exception in EnumUtility BitwiseAnd:" + e);
            }
        }
        ...
        public static int EnumOr(RealStatePtr L)
        {
            try
            {
                ...
                if (!typeOfLeft.IsEnum() || typeOfLeft != right.GetType())
                {
                    return LuaAPI.luaL_error(L, "invalid argument for EnumUtility BitwiseOr");
                }
                translator.PushAny(L, Enum.ToObject(typeOfLeft, Convert.ToInt64(left) | Convert.ToInt64(right)));
                return 1;
            }
            ...
            {
                return LuaAPI.luaL_error(L, "c# exception in EnumUtility BitwiseOr:" + e);
            }
        }
            ...
            try
            {
                ...
                foreach (var loader in self.customLoaders)
                {
                    ...
                    if (bytes != null)
                    {
                        ...
                        {
                            return LuaAPI.luaL_error(L, String.Format("error loading module {0} from CustomLuaLoader, {1}",
                                LuaAPI.lua_tostring(L, 1), LuaAPI.lua_tostring(L, -1)));
                        }
                        return 1;
                    }
