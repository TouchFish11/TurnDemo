...
namespace GameLogic.BattleMoudule.Toughness
{
    ...
    public class ToughnessComponent : MonoBehaviour, IToughnessComponent
    {
        ...
        public void Init(IBattleEntity owner, List<E_PropertyType> weakPropertys, float initialToughness)
        {
            _owner = owner;
        ...
        private void OnSkillCastHandler(SkillCastEvent skillCastEvent)
        {
            ...
            if (!skillCastEvent.Contain(_owner))
            {
                return;
            }
            ...
            if (_toughness.IsBroken)
            {
                ...
                BattleEventCenter.TriggerEvent(new ToughnessBrokenEvent(skillCastEvent.Context, skillCastEvent.Caster, _owner));
            }
        }
