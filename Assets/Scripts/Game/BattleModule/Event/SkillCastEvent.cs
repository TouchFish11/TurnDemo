...
namespace GameLogic.BattleMoudule.Event
{
    ...
    public class SkillCastEvent : BattleEvent
    {
        ...
        /// 技能目标
        /// </summary>
        public List<IBattleEntity> Targets { get; }
        ...
        public SkillCastEvent(IBattleContext context, IBattleEntity caster, List<IBattleEntity> targets, ISkill skill, float damage, E_PropertyType attackAttr) : base(context)
        {
            Caster = caster;
            Targets = targets;
            Skill = skill;
        ...
        public bool Contain(IBattleEntity battleEntity)
        {
