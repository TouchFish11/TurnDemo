...
public class BattleUtil
{
    ...
    //{
    //    return BinaryDataMgr.Instance.GetTable<T_SkillInfoContainer>().dataDic[BattleManager.Instance.BattleFlowController.GetCurrentActCharacter().GetCurrentSkillID()];
    //}
