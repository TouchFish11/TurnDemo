    ...
    public override void SetPropertyValue(E_DynamicPropertyType dynamicPropertyType, int newValue)
    {
        ...
        switch (dynamicPropertyType)
        {
            case E_DynamicPropertyType.CurrentEnergy:
                ...
                battleContext.GetEventBus().TriggerEvent(new EnergyChangedEvent(battleContext, this.BattleEntity, RoleProperty.CurrentEnergy, RoleProperty.BaseEnergy, currentEnergyDelta));
                break;
        }
    }
