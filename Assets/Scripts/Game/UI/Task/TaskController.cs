...
namespace Game.UI
{
    ...
    public class TaskController : UIController<TaskView, TaskModel>
    {
        ...
        {
            // 创建该任务类型父对象
            TaskTypeContainer taskTypeContainer = await ObjectBuilder.GetObject<TaskTypeContainer>(E_AssetBundleType.UI, ResKeyCollection.TaskTypeContainer, null);
        ...
        {
            TaskItem taskItem = await ObjectBuilder.GetObject<TaskItem>(E_AssetBundleType.UI, ResKeyCollection.TaskItem, container.transform);
