...
namespace Core.Exceptions
{
    ...
    public static class ExceptionHelper
    {
        ...
        public static AssetLoadException ThrowAssetLoadException(string assetKey, Exception innerException = null)
        {
        ...
        public static AssetsLoadException ThrowAssetsLoadException(string bundleName, Type type, Exception innerException = null)
        {
        ...
        public static AssetBundleUnloadException ThrowAssetBundleUnloadException(string bundleName, uint refCount, Exception innerException = null)
        {
        ...
        public static InvalidHandleAccessException ThrowInvalidHandleAccessException(int handleId, int version, Exception innerException = null)
        {
        ...
        public static UICreateException ThrowUICreateException(Type uiType, Exception innerException = null)
        {
        ...
        public static EventTriggerException ThrowEventTriggerException(Type eventType, Exception innerException = null)
        {
