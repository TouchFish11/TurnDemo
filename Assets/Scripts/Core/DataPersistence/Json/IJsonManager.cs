...
namespace Core.DataPersistence.Json
{
    ...
    public interface IJsonManager
    {
        ...
        T FromJson<T>(string json, E_JsonType jsonType = E_JsonType.Newtonsoft) where T : new();
        ...
        Task<T> FromJsonAsync<T>(string path, E_JsonType jsonType = E_JsonType.Newtonsoft) where T : new();
        ...
        void SaveToJson(object data, string saveFilePath, E_JsonType type = E_JsonType.Newtonsoft);
        ...
        Task SaveToJsonAsync(object data, string saveFilePath, E_JsonType type = E_JsonType.Newtonsoft);
    }
}
