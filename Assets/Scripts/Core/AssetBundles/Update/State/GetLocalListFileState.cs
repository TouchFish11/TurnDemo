...
namespace Core.AssetBundles.Update.State
{
    ...
    public class GetLocalListFileState : UpdateState
    {
        ...
        public override async Task<bool> Execute()
        {
            ...
            // 切换状态到对比校验阶段
            assetBundleUpdater.ChangeState(EUpdatePhase.CompareContrast);
            return IsSuceess;
        }
        ...
        public async Task<bool> GetLocalCompareFileInfo()
        {
            ...
            if (File.Exists(persistentListPath))
            {
                ...
                return await GetLocaListFileInfo("file:///" + persistentListPath);
            }
        ...
        private async Task<bool> GetLocaListFileInfo(string localFilePath)
        {
            ...
            LogManager.LogError($"本地AB对比文件获取失败：{req.result}-{req.error}");
            return false;
        }
