...
namespace GameHotUpdate.Battle.Object.Role.Wizard.Skill
{
    ...
    public class WizardBattleSkill : PlayerSkill
    {
        ...
        /// <param name="statusAddStrategy">状态添加策略（如附加buff/debuff）</param>
        public WizardBattleSkill(IBattleEntityObject caster, int skillId, IStatusAddStrategy statusAddStrategy) : base(caster, skillId, statusAddStrategy)
        {
        }
        ...
        protected override IEnumerator OnCast(IBattleContext context)
        {
            ...
            ServiceLocator.Get<IVFXManager>().CreateVFX(ResKeyCollection.VFX_WizardBattleSkill, projectileTrans, projectileData, vFXInfo);
