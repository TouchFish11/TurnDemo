...
namespace GameHotUpdate.Battle.Object.Role.Wizard.Projectile
{
    ...
    /// 法师战技技能弹射物
    /// </summary>
    public class WizardBattleSkillProjectile : InstantProjectile
    {
        ...
        protected override void CreateVFXOnTrigger()
        {
            foreach (var target in projectileData.targets)
            {
                ...
                ServiceLocator.Get<IVFXManager>().CreateVFX(ResKeyCollection.VFX_IcePropertySkill_Hit, projectileTrans, default, newVFXInfo);
                // 计时器计时
