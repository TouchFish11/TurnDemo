...
namespace GameHotUpdate.Battle.Object.Monster.AbyssalMage.Skill
{
    ...
    public class AshfallSkill : MonsterSkill
    {
        ...
        public AshfallSkill(IBattleEntityObject caster, int skillId, IStatusAddStrategy statusAddStrategy) : base(caster, skillId, statusAddStrategy)
        {
        }

        protected override void InitProjectile()
        {
            LogManager.Log($"当前技能：{this}");
        }
        ...
        private void CreateVFX_01()
        {
            ...
            // 创建特效
            ServiceLocator.Get<IVFXManager>().CreateVFX(ResKeyCollection.VFX_AbyssLockSkillProjectile, projectileTrans, projectileData, vFXInfo);
        }
        ...
        private void CreateVFX_02()
        {
            ...
            vFXInfo = ServiceLocator.Get<IPoolManager>().GetData<VFXInfo>();
            // 创建特效
            ServiceLocator.Get<IVFXManager>().CreateVFX(ResKeyCollection.VFX_AshfallSkillProjectile, projectileTrans, projectileData, vFXInfo);
        }
    }
}
