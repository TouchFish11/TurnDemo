...
namespace HotUpdate.Game.Quests.Data
{
    ...
    public class TaskDataProvider : ITaskDataProvider
    {
        ...
        public async Task SaveDataAsync()
        {
            ...
            Logger.Log($"{nameof(TaskDataProvider)}.{nameof(SaveDataAsync)}:任务数据保存成功，{FileUtility.LocalTaskDataFileName}");
        }
        ...
        public void SaveData()
        {
            ...
            Logger.Log($"{nameof(TaskDataProvider)}.{nameof(SaveData)}:任务数据保存成功，{FileUtility.LocalTaskDataFileName}");
        }
    }
}
