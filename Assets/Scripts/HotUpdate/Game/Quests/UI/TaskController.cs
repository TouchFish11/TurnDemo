...
namespace HotUpdate.Game.Quests.UI
{
    ...
    public class TaskController : UIController<TaskView>
    {
        ...
        private async Task InitTasks()
        {
            ...
            // 获取任务数据集合
            _questCollection = DIContainer.GetInstance<IGameManager>().GameDataManager.GetProvider<ITaskDataProvider>().QuestCollection;
        ...
        private void UpdateQuestDetail(int id)
        {
            ...
            var questCollection = DIContainer.GetInstance<IGameManager>().GameDataManager.GetProvider<ITaskDataProvider>().QuestCollection;
