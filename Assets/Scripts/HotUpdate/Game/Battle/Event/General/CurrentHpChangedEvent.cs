...
namespace HotUpdate.Game.Battle.Event.General
{
    ...
    /// </summary>
    public class CurrentHpChangedEvent : BattleEvent
    {
        /// <summary>
        /// 生命值变更的目标实体
        ...
        public CurrentHpChangedEvent(IBattleContext context, float currentHp, float maxHp, IBattleEntityObject target) : base(context)
        {
            CurrentHp = currentHp;
            MaxHp = maxHp;
            Target = target;
