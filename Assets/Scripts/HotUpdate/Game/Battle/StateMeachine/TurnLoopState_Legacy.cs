...
namespace HotUpdate.Game.Battle.StateMeachine
{
    ...
    /// </summary>
    [Obsolete]
    public class TurnLoopState_Legacy : BattleState
    {
        ...
        public TurnLoopState_Legacy(IBattleStateMachine battleStateMachine, IBattleContext context) : base(battleStateMachine, context)
        {
