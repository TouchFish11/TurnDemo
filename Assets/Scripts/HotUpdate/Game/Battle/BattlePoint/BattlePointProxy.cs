...
namespace HotUpdate.Game.Battle.BattlePoint
{
    /// <summary>
    /// 场景战斗点代理
    /// </summary>
    public class BattlePointProxy : IBattlePointProxy, IDestroyable
    {
        ...
        /// 场景战斗点
        /// </summary>
        public Base.Battle.Point.BattlePoint BattlePoint { get; } = UnityEngine.Object.FindFirstObjectByType<Base.Battle.Point.BattlePoint>();
