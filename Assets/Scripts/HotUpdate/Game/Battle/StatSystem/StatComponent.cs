...
namespace HotUpdate.Game.Battle.StatSystem
{
    ...
    public abstract class StatsComponent : BattleComponent
    {
        ...
        public void UpdateShield(float amount)
        {
            ...
            BattleEntity.Context.EventBus.TriggerEvent(new ShieldChangedEvent(BattleEntity.Context, StatsComponentCore.StatSet.CurrentShield, BattleEntity, amount));
        }
        ...
        public void AddBaseStat(EStatType statType, IStatModifier modifier)
        {
            ...
            StatsComponentCore.AddBaseStatModifier(statType, modifier);
        ...
        public void AddFinalStat(EStatType statType, IStatModifier modifier)
        {
            ...
            StatsComponentCore.AddFinalStatModifier(statType, modifier);
            BattleEntity.Context.EventBus.TriggerEvent(new StatChangedEvent(BattleEntity.Context, GetStatInternal(statType)));
        }
        ...
        {
            return GetStatInternal(statType).TryGetModifier(modifierId, out modifier);
        }

        public bool TryGetBaseModifier(EStatType statType, long modifierId, out IStatModifier modifier)
        {
            return GetStatInternal(statType).TryGetBaseModifier(modifierId, out modifier);
        }
        ...
        {
            return GetStatInternal(statType);
        }
        ...
        /// <param name="statType"></param>
        /// <returns></returns>
        private Stat GetStatInternal(EStatType statType)
        {
