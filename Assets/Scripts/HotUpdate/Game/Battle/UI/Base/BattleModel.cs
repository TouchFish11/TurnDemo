...
namespace HotUpdate.Game.Battle.UI.Base
{
    ...
    public class BattleModel : UIModel
    {
        ...
        public void ClearWaitingActUI()
        {
            ...
            {
                DIContainer.GetInstance<IPoolManager>().PushObj(waitingActUI.gameObject);
            }
            waitingActUIs.Clear();
        }
        ...
        public void ClearActionBar()
        {
            ...
            {
                DIContainer.GetInstance<IPoolManager>().PushObj(actionGridUI.gameObject);
            }
            actions.Clear();
        }
        ...
        public void SetOperator(List<SkillKeyUI> skillKeyUIs)
        {
            ...
            {
                DIContainer.GetInstance<IPoolManager>().PushObj(skillKeyUI.gameObject);
            }
        ...
        public void UpdateBattlePointCount(int current, IEnumerable<BattlePointUI> battlePointUIs)
        {
            ...
            {
                DIContainer.GetInstance<IPoolManager>().PushObj(battlePointUI.gameObject);
            }
        ...
        public void ClearSelectMarkers()
        {
            ...
            {
                DIContainer.GetInstance<IPoolManager>().PushObj(selectMarkerUI.gameObject);
            }
