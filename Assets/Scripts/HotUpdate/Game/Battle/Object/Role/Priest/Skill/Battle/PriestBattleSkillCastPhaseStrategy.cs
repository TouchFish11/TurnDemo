...
namespace HotUpdate.Game.Battle.Object.Role.Priest.Skill.Battle
{
    public class PriestBattleSkillCastPhaseStrategy : SkillCastPhaseStrategy
    {
        ...
        private readonly string _stateName = BattleAttackState;
        private readonly float _targetEndProgress = 0.5f;
        private string _vfxName = AssetKeys.VFX_Priest_BattleSkill;
