...
namespace HotUpdate.Game.Battle.Object
{
    ...
    public abstract class MonsterObject : BattleObject, IMonsterObject
    {
        ...
        public override void BaseInit(int id)
        {
            ...
            MonsterInfo = DIContainer.GetInstance<IBinaryDataManager>().GetConfig<MonsterInfoContainer>(EConfigLoadType.Excel).dataDic[id];
        }
        ...
        public override IEnumerator Die()
        {
            ...
            yield return TaskUtility.WaitForTask(DIContainer.GetInstance<IVFXManager>().CreateVFX(
                ...
                vFXInfo));
            // 播放怪物死亡动画，并等待动画播放完成
            StartCoroutine(AnimationPlayUtility.WaitForAnimOver(GetComponent<IBattleAnimationComponent>(), AnimationUtility.Battle_Layer_Name, (int)E_AnimationType.Death));
