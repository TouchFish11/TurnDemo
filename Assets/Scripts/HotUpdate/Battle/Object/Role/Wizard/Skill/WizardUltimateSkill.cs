...
namespace HotUpdate.Battle.Object.Role.Wizard.Skill
{
    /// <summary>
    /// 法师终结技逻辑类
    ...
    public class WizardUltimateSkill : UltimateSkill
    {
        ...
        protected override async void InitProjectileAndPoseVfx()
        {
            ...
            vFXInfo = new VFXInfo();
            // 创建释放姿势的特效
            await ServiceLocator.Get<IVFXManager>().CreateVFX(ResKeyCollection.VFX_WizardUltimatePose, projectileTrans, projectileData, vFXInfo);
        }
