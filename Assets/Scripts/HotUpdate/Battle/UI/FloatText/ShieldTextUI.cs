...
namespace HotUpdate.Battle.UI.FloatText
{
    public class ShieldTextUI : UIBehaviourBase
    {
        ...
        [Inject(1)] private RectTransform ShieldTextMover { get; set; }
        ...
        protected override void OnEnable()
        {
            ...
            // 设置文字初始缩放（放大显示）
            ShieldTextMover.localScale = StartScale;
        }
        ...
        public void InitshieldText(int shieldAmount)
        {
            ...
            {
                // 设置护盾数值文本内容（转为字符串）
                txtShieldNum.text = shieldAmount.ToString();
            }
        ...
        private void OnUpdate()
        {
            ...
            ShieldTextMover.localScale = Vector3.Lerp(ShieldTextMover.localScale, endScale, Time.deltaTime * scaleFactor);
            // 向上移动：每帧按移动速度向上偏移位置
            ShieldTextMover.Translate(Time.deltaTime * upMoveSpeed * Vector3.up);
        }
