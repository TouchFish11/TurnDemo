...
namespace HotUpdate.UI.Begin
{
    ...
    public class BeginController : UIController<BeginView>
    {
        ...
        private async void OnUpdateOver(UpdateResult updateResult)
        {
            ...
            {
                Logger.LogError($"{nameof(BeginController)}.{nameof(OnUpdateOver)}：{e.Message}，{e.StackTrace}");
            }
        }
        ...
        private async void EnterMain()
        {
            ...
            {
                Logger.LogError($"{nameof(BeginController)}.{nameof(EnterMain)}：{e.Message}，{e.StackTrace}");
            }
        }
        ...
        protected override async void OnButtonClick(string btnName)
        {
            ...
            {
                Logger.LogError($"{nameof(BeginController)}.{nameof(OnButtonClick)}：{e.Message}，{e.StackTrace}");
            }
        }
    }
}