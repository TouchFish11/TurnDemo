...
namespace Framework
{
    ...
    public class ExcelTool
    {
        ...
        private static void GenerateExcelDataClass(DataTable table)
        {
            ...
            string dataClassStr = "public class " + table.TableName + "\n" + "{\n";
        ...
        private static void GenerateExcelContainer(DataTable table)
        {
            ...
            string dataContainerStr = "using System.Collections.Generic;\n\n";
        ...
        private static void GenerateExcelBinary(DataTable table)
        {
            ...
            using (FileStream fs = new FileStream(TableInfoEditorSavePath + table.TableName + ".tInfo.txt", FileMode.OpenOrCreate, FileAccess.Write))
            {
